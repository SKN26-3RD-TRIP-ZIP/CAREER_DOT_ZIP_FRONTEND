...
export default function GrowthTrendPage() {
  ...
  return (
    <ReportLayout title="최근 성장 추이" subtitle="여러 면접 세션의 점수 변화와 보완 항목 개선 흐름을 확인합니다." action={back}>
      <section className="grid grid-cols-2 gap-6 rounded-xl border border-slate-200 bg-white p-6 shadow-sm md:grid-cols-4">
      ...
      <section className="mt-4 grid gap-4 lg:grid-cols-3">
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm lg:col-span-2">
          <h3 className="mb-4 text-lg font-bold text-slate-900">Growth Track Chart</h3>
          <GrowthLineChart points={g.points} />
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <h3 className="mb-4 text-lg font-bold text-slate-900">성장 인사이트</h3>
